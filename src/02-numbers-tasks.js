...
//  */
// function getAverage(value1, value2) {
//   const a = value1 / Number.MAX_SAFE_INTEGER;
//   const b = value2 / Number.MAX_SAFE_INTEGER;
//   return ((a + b) / 2) * Number.MAX_SAFE_INTEGER;
// }
...
//  */
// function getAngleBetweenVectors(x1, y1, x2, y2) {
//   const sqrt = Math.sqrt(x1 ** 2 + y1 ** 2);
//   const sqrt2 = Math.sqrt(x2 ** 2 + y2 ** 2);
//   return Math.acos(((x1 * x2 + y1 * y2) / sqrt) * sqrt2);
// }
