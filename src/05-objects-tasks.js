...
//  *
//  * The task is to design a single class, independent classes or classes hierarchy
//  * and implement the functionality to build the
//  css selectors using the provided cssSelectorBuilder.
//  * Each selector should have the stringify() method to output the string representation
//  * according to css specification.
//  *
//  * Provided cssSelectorBuilder should be used as facade only to create your own classes,
...
//     checkOrder(newMethod) {
//       const rightOrder = ['element', 'id', 'class', 'attr', 'pseudoClass', 'pseudoElement'];
//       if (rightOrder.indexOf(newMethod) >=
// rightOrder.indexOf(this.order[this.order.length - 1])) {
//         this.order.push(newMethod);
//       } else {
...
//       this.checkOrder('element');
//       if (this.selectors.element) {
//         throw new Error('Element, id and pseudo-element should
